...
class Request
{
        ...
        {	
            ...
            public void actionPerformed(ActionEvent arg0) {
            	...
            	boolean bWinter=winter.isSelected();
            	boolean bSpring=spring.isSelected();
            	boolean bSummer=summer.isSelected();
            	boolean bFall=fall.isSelected();
            	int slots= (Integer) comboSlots.getSelectedItem();
            	int s1 = (Integer) startTime1.getSelectedItem();
            	int e1 = (Integer) endTime1.getSelectedItem();
            	int s2 = (Integer) startTime2.getSelectedItem();
            	int e2 = (Integer) endTime2.getSelectedItem();
            	int s3 = (Integer) startTime3.getSelectedItem();
            	int e3 = (Integer) endTime3.getSelectedItem();
            	int s4 = (Integer) startTime4.getSelectedItem();
            	int e4 = (Integer) endTime4.getSelectedItem();
            	int s5 = (Integer) startTime5.getSelectedItem();
            	int e5 = (Integer) endTime5.getSelectedItem();
            	...
            	String reqDay1=comboDay1.getSelectedItem().toString();
            	String reqDay2=comboDay2.getSelectedItem().toString();
            	String reqDay3=comboDay3.getSelectedItem().toString();
            	String reqDay4=comboDay4.getSelectedItem().toString();
            	String reqDay5=comboDay5.getSelectedItem().toString();
            	
            	TimeSlot ts1 = new TimeSlot(reqDay1, array1);
            	TimeSlot ts2 = new TimeSlot(reqDay2, array2);
            	TimeSlot ts3 = new TimeSlot(reqDay3, array3);
            	TimeSlot ts4 = new TimeSlot(reqDay4, array4);
            	TimeSlot ts5 = new TimeSlot(reqDay5, array5);
            	
            	
            	TimeSlot[] tsArray = new TimeSlot[5];
            	tsArray[0]=ts1;
            	tsArray[1]=ts2;
            	tsArray[2]=ts3;
            	tsArray[3]=ts4;
            	...
            	RequestedEvent newEvent = new RequestedEvent(reqName, room, bWinter,
            			bFall, bSpring, bSummer,slots,tsArray );
                ...
                JOptionPane.showMessageDialog(f.getComponent(0),"Your event has been sent to the principal for further review.");
